...
})(PanelVariants || (exports.PanelVariants = PanelVariants = {}));
...
const Panel = (_a) => {
    var { open = false, anchor, variant, tabList, hideSidebar, selectedTabValue, panelVariant = PanelVariants.WITH_PADDING, handleTabChange, togglePanel, isPanelCollapsed = false, translation, togglePanelLabel } = _a, rest = __rest(_a, ["open", "anchor", "variant", "tabList", "hideSidebar", "selectedTabValue", "panelVariant", "handleTabChange", "togglePanel", "isPanelCollapsed", "translation", "togglePanelLabel"]);

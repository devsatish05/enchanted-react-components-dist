...
const TextField = react_1.default.forwardRef((_a, forwardRef) => {
    ...
    const props = Object.assign({ margin: 'none', color: 'primary', size: 'medium', label: '', helperText: '', helperIconTooltip: '', placeholder: '', unitLabel: '', required: false, disabled: false, error: false, fullWidth: false, multiline: false, focused: false, autoFocus: false, hiddenLabel: false, nonEdit: false }, rawProps);
    if (!props.id) {

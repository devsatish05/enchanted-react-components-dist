            ...
            react_1.default.createElement(ListItem_1.default, { disablePadding: true, sx: { paddingLeft: (queueItem.type !== ProgressBar_1.ProgressItemType.Folder && folderId === queueItem.collectionId) ? '8px' : '0px' }, hasBorder: true },
                react_1.default.createElement(ListItemButton_1.default, { size: ListItemButton_1.ListSizes.SMALL, secondaryActionButton: renderHoverIcon(queueItem), onMouseEnter: () => { return setHover(`${queueItem.name}_${queueItem.timestamp}`); }, onMouseLeave: () => { return setHover(null); }, onFocus: () => { return setFocus(`${queueItem.name}_${queueItem.timestamp}`); }, onBlur: () => { return setFocus(null); }, disabledHover: queueItem.status === ProgressBar_1.EnumUploadStatus.CANCELLED },
                    queueItem.status === ProgressBar_1.EnumUploadStatus.SUCCESS
                        ? (react_1.default.createElement(ListItemAvatar_1.default, null, react_1.default.createElement(Avatar_1.default, { iconImage: queueItem.type === ProgressBar_1.ProgressItemType.Folder ? react_1.default.createElement(folder_1.default, null) : iconImage, color: Avatar_1.AvatarColors.DEFAULT, variant: "rounded", type: Avatar_1.AvatarTypes.ICON, style: { height: '24px', width: '24px' } }))) : (react_1.default.createElement(ListItemAvatar_1.default, null, react_1.default.createElement(Avatar_1.default, { iconImage: queueItem.type === 'folder' ? react_1.default.createElement(folder_1.default, null) : iconImage, color: Avatar_1.AvatarColors.DEFAULT, variant: "rounded", type: Avatar_1.AvatarTypes.ICON, style: { height: '24px', width: '24px', opacity: 0.38 } }))),

...
const renderInputLabelAndAction = (props) => {
    if (props.actionProps) {
        ...
        return (react_1.default.createElement(exports.MuiGrid, { container: true, spacing: 2 },
            ...
            react_1.default.createElement(exports.MuiGrid, { size: "auto", sx: (theme) => {
                ...
                return (react_1.default.createElement(Tooltip_1.default, { title: actionProp.tooltip, tooltipsize: "small", placement: "bottom", key: `${actionProp.label}-${index}` },
    ...
    return (react_1.default.createElement(exports.MuiGrid, { container: true },
        react_1.default.createElement(exports.MuiGrid, { size: 12 }, renderInputLabel(props))));
};

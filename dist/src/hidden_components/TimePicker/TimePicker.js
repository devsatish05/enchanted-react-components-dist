...
const TimePicker = (_a) => {
    ...
    return (react_1.default.createElement(TimePicker_1.TimePicker, Object.assign({}, props, { slots: { textField: TextField_1.default }, slotProps: { textField: textFieldSlotProps } })));
};

...
declare function ListItemText({ tooltip, tooltipPlacement, forceTooltip, secondaryTooltip, secondaryTooltipPlacement, ...props }: ListItemTextProps): React.JSX.Element;

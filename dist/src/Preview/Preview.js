...
})(PreviewTestIds || (exports.PreviewTestIds = PreviewTestIds = {}));
var AssetType;
(function (AssetType) {
...
const Preview = ({ open = true, reactComponent, renditionLabel, assets, index = 0, isSelectButtonDisabled, selectButtonTitle, onClickBackButton, handleSelect, handleDownload, tooltipTexts, isNextButtonDisabled, isPreviousButtonDisabled, overrideHandleNext, overrideHandlePrevious, isFetchingAssets = false, customHeaderTitle, handleError, isVersionComparison = false, }) => {
    ...
    const handleResize = () => {
        ...
        if (videoRef.current && imageContainerRef.current) {
            const videoWidth = (_e = (_a = videoRef.current) === null || _a === void 0 ? void 0 : _a.videoWidth) !== null && _e !== void 0 ? _e : 0;
            const videoHeight = (_f = (_b = videoRef.current) === null || _b === void 0 ? void 0 : _b.videoHeight) !== null && _f !== void 0 ? _f : 0;
            const aspectRatio = videoHeight / videoWidth;
            const containerWidth = imageContainerRef.current.offsetWidth;
            const calculatedHeight = containerWidth * aspectRatio;
            if (calculatedHeight < ((_c = imageContainerRef.current) === null || _c === void 0 ? void 0 : _c.clientHeight)) {
                videoRef.current.style.height = `${containerWidth * aspectRatio}px`;
                videoRef.current.style.width = `${containerWidth}px`;
            }
            else {
                videoRef.current.style.height = `${(_d = imageContainerRef.current) === null || _d === void 0 ? void 0 : _d.clientHeight}px`;
    ...
    const calculateImagePercentage = () => {
        var _a, _b, _c, _d;
        var _e, _f, _g, _h;
        const imgHeight = (_e = (_a = imageRef.current) === null || _a === void 0 ? void 0 : _a.height) !== null && _e !== void 0 ? _e : 0;
        const imgContainerHeight = (_f = (_b = imageContainerRef === null || imageContainerRef === void 0 ? void 0 : imageContainerRef.current) === null || _b === void 0 ? void 0 : _b.clientHeight) !== null && _f !== void 0 ? _f : 0;
        ...
        const imageContainerWidth = (_g = (_c = imageContainerRef === null || imageContainerRef === void 0 ? void 0 : imageContainerRef.current) === null || _c === void 0 ? void 0 : _c.clientWidth) !== null && _g !== void 0 ? _g : 0;
        const imageWidth = (_h = (_d = imageRef.current) === null || _d === void 0 ? void 0 : _d.width) !== null && _h !== void 0 ? _h : 0;
    ...
    return (React.createElement(Backdrop_1.default, { open: open, sx: {
        ...
        React.createElement(PreviewContainer, { container: true, direction: "column", justifyContent: "flex-start", sx: {
            ...
            React.createElement(material_1.Grid, null, React.createElement(Header_1.default, { sx: {

...
const DatePicker = (_a) => {
    ...
    if (staticMode) {
        return (react_1.default.createElement(Paper_1.default, { variant: "elevation", sx: (theme) => { return getDatePickerStyle(theme, customStyles, true); } },
            react_1.default.createElement(StaticDatePicker_1.StaticDatePicker, Object.assign({}, muiProps, { disabled: disabled, value: value }, { view: staticView }, { onViewChange: handleStaticViewChange, onAccept: handleStaticAccept, closeOnSelect: false, reduceAnimations: true, dayOfWeekFormatter: dayOfWeekFormatter, slots: {

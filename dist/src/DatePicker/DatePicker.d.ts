...
export interface DatePickerProps<TDate> extends Omit<MuiDatePickerProps<TDate>, 'slots' | 'slotProps'> {
    label?: string;
    helperText?: string;
...
declare const DatePicker: <TDate>({ customStyles, staticMode, margin, color, size, label, helperText, enableHelpHoverEffect, helperIconTooltip, format, unitLabel, required, disabled, fullWidth, hiddenLabel, nonEdit, error, actionProps, customIcon, value, onViewChange, onAccept, ...muiProps }: DatePickerProps<TDate>) => React.JSX.Element;

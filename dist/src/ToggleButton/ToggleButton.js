...
const ToggleButton = react_1.default.forwardRef((_a, forwardRef) => {
    ...
    const props = Object.assign({ variant: ToggleButtonVariants.WITH_PADDING, disabled: false, disableFocusRipple: true, disableRipple: true, centerRipple: false, disableTouchRipple: false, focusRipple: false, tabIndex: 0 }, rawProps);

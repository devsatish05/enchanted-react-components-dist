...
})(ButtonVariants || (exports.ButtonVariants = ButtonVariants = {}));
var ButtonTestIds;
(function (ButtonTestIds) {
    ButtonTestIds["CONTAINED"] = "Contained";
    ButtonTestIds["OUTLINED"] = "Outlined";
    ButtonTestIds["TEXT"] = "Text";
})(ButtonTestIds || (exports.ButtonTestIds = ButtonTestIds = {}));
const Button = react_1.default.forwardRef((_a, forwardRef) => {
    var rawProps = __rest(_a, []);
    const props = Object.assign({ variant: ButtonVariants.CONTAINED, disableElevation: true, disableFocusRipple: true, fullWidth: false, centerRipple: false, disableRipple: false, disableTouchRipple: false, focusRipple: false, tabIndex: 0, inversecolors: false }, rawProps);

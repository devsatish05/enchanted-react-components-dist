...
const DataGrid = (_a) => {
    ...
    return (react_1.default.createElement(StyledDataGrid, Object.assign({}, props, { page: page, pageSize: pageSize, totalCount: totalCount, translation: translation, rowsPerPageOptions: rowsPerPageOptions, focusedRow: focusRow, 

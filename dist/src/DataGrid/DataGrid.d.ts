...
declare function DataGrid({ slots, slotProps, page, pageSize, totalCount, translation, rowsPerPageOptions, onCheckboxClick, onPageChange, onPageSizeChange, ...props }: DataGridProps): React.JSX.Element;

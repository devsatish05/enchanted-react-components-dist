...
const Select = react_1.default.forwardRef((_a, forwardRef) => {
    ...
    const props = Object.assign({ margin: 'none', color: 'primary', size: 'medium', label: '', helperText: '', enableHelpHoverEffect: false, helperIconTooltip: '', placeholder: '', unitLabel: '', required: false, disabled: false, error: false, fullWidth: false, autoFocus: false, hiddenLabel: false, nonEdit: false, sx: { minWidth: '240px' } }, rawProps);
    if (!props.id) {

...
exports.actionButtonDefaultProps = void 0;
/* ======================================================================== *
...
exports.actionButtonDefaultProps = {
    label: 'Action',
    endIcon: false,
    disabled: false,
};
const ActionButton = (_a) => {
    var { label = exports.actionButtonDefaultProps.label || '', endIcon = exports.actionButtonDefaultProps.endIcon, disabled = exports.actionButtonDefaultProps.disabled } = _a, props = __rest(_a, ["label", "endIcon", "disabled"]);
    return (react_1.default.createElement(StyledBox, { "data-testid": "action-button", className: disabled ? 'disabled' : '', tabIndex: disabled ? -1 : 0, onClick: (event) => {
            if (props.href) {

...
})(ChipVariants || (exports.ChipVariants = ChipVariants = {}));
var ChipTestIds;
(function (ChipTestIds) {
    ChipTestIds["CHIP_ROOT"] = "ChipRoot";
})(ChipTestIds || (exports.ChipTestIds = ChipTestIds = {}));
const Chip = (_a) => {
    var props = __rest(_a, []);
        ...
        MuiChip: {
            styleOverrides: {
                root: ({ ownerState, theme }) => {
                    ...
                    const leadingLetter = (_b = (_a = ownerState.avatar) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0 ? void 0 : _b.letter;

...
const CalendarCell = react_1.default.memo(({ date, items, view, isCurrentMonth, isToday, isSelected, isFocused = false, isLastRow = false, isLastColumn = false, disabled = false, onDateClick, onItemClick, onKeyDown, dateFormatLong = 'MMMM D, YYYY', dayFormat = 'D', dayAbbreviationFormat = 'ddd', timePreposition = 'at', locale = 'en', }) => {

...
declare const DataGrid: {
    ({ slots, slotProps, page, pageSize, totalCount, translation, rowsPerPageOptions, onCheckboxClick, onPageChange, onPageSizeChange, ...props }: DataGridProps): React.JSX.Element;
    defaultProps: {
        rowHeight: number;

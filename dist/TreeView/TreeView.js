...
require("@mui/x-tree-view/themeAugmentation");
...
const TreeView = react_1.default.forwardRef((props, ref) => {
    ...
    return (react_1.default.createElement(TreeItem_1.TreeViewContext.Provider, { value: contextValue },
        react_1.default.createElement(x_tree_view_1.SimpleTreeView, Object.assign({ ref: combinedRef, slots: {
                collapseIcon: defaultCollapseIcon ? () => { return defaultCollapseIcon; } : chevron__down_1.default,

...
(function (HeaderDemo) {
    ...
    HeaderDemo["DAM"] = "DAM";
    HeaderDemo["CR"] = "CR";
})(HeaderDemo || (exports.HeaderDemo = HeaderDemo = {}));
...
})(HeaderPageVariant || (exports.HeaderPageVariant = HeaderPageVariant = {}));
var HeaderTestIds;
...
})(HeaderTestIds || (exports.HeaderTestIds = HeaderTestIds = {}));
...
const Header = (_a) => {
    ...
    return (react_1.default.createElement(MuiContainer, Object.assign({}, muiContainerProps),
        react_1.default.createElement(MuiGrid, { container: true, spacing: 2, "data-testid": HeaderTestIds.HEADER_CONTAINER },
            react_1.default.createElement(StartSectionGridStyled, { size: 4, sx: { '&.MuiGrid-root': { paddingLeft: hamburgerSpace ? '68px' : '12px' } }, "data-testid": HeaderTestIds.HEADER_START_SECTION },
            ...
            withMiddleSection && (react_1.default.createElement(MiddleSectionGridStyled, { size: 4, "data-testid": HeaderTestIds.HEADER_MIDDLE_SECTION }, middleSection === null || middleSection === void 0 ? void 0 : middleSection.map((eachIcon, index) => {
            ...
            react_1.default.createElement(EndSectionGridStyled, { size: withMiddleSection ? 4 : 8, "data-testid": HeaderTestIds.HEADER_END_SECTION }, endSection === null || endSection === void 0 ? void 0 : endSection.map((eachElement, index) => {
